...
<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left">
				<img src="image/slider-01-1.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Recommended Menu</strong></h1>
			...
			<li class="text-left">
				<img src="image/slider-02-1.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Recommended Menu</strong></h1>
			...
			<li class="text-left">
				<img src="image/slider-03-1.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Recommended Menu</strong></h1>
	...
	<div class="about-section-box">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 text-center">
						<div class="inner-column">
							<h1>Welcome To <span>Chuen Cafe Recommended Menu</span></h1>
							<h4>Little Story</h4>
		...
		<div class="container">
		<h1><span>Recommended Menu</span></h1>
        <table>
            <thead>
                <tr>

		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Basic Menu</strong></h1>
			...
			<li class="text-left">
				<img src="image/slider02.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Basic Menu</strong></h1>
			...
			<li class="text-left">
				<img src="image/slider03.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Chuen Cafe Basic Menu</strong></h1>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 text-center">
						<div class="inner-column">
							<h1>Welcome To <span>Chuen Cafe Basic Menu</span></h1>
							<h4>Little Story</h4>
